...
def test_invalid_boundary(bad_boundary):
    ...
    with pytest.raises(ValueError):
        BioSim(island_map="{}WW\nWLW\nWWW".format(bad_boundary), ini_pop=[], seed=1)
...
@pytest.mark.parametrize("species, extra", [("Herbivore", {}), ("Carnivore", {"DeltaPhiMax": 0.5})])
...
@pytest.mark.parametrize("lscape, params", [("L", {"f_max": 100.0}), ("H", {"f_max": 200.0})])
