...
class Visualization:
    ...
    def update_fitness(self, data_1, data_2):
        ...
        ----------
        data_1 : dict
                Dict that contains information about fitness for all herbivores present on island.
        data_2 : dict
    ...
    def update_age(self, data_1, data_2):
        ...
        ----------
        data_1 : dict
                Dict that contains information about age for all herbivores present on island.
        data_2 : dict
    ...
    def update_weight(self, data_1, data_2):
        ...
        ----------
        data_1 : dict
                Dict that contains information about weight for all herbivores present on island.
        data_2 : dict
